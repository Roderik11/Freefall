...
namespace Freefall.Graphics
{
    ...
    public class QuadTreeNode
    {
        ...
        public static event NodeCallback OnSplit = delegate { };
        public static event NodeCallback OnMerged = delegate { };

        public static NodeCallback OnDraw = delegate { };
        ...
        // Removed RenderPass overload as RenderPass might not be available or needed yet. Can check later.
