...
namespace Freefall.Components
{
    public class Terrain : Freefall.Base.Component, IUpdate, IDraw, IHeightProvider
    {
        ...
        private void CreateControlMaps(GraphicsDevice device)
        {
            ...
            var filenames = new[] {
                Path.Combine(AppContext.BaseDirectory, "Resources", "Terrain", "Terrain_splatmap_0.dds"),
                Path.Combine(AppContext.BaseDirectory, "Resources", "Terrain", "Terrain_splatmap_1.dds"),
                Path.Combine(AppContext.BaseDirectory, "Resources", "Terrain", "Terrain_splatmap_2.dds"),
                Path.Combine(AppContext.BaseDirectory, "Resources", "Terrain", "Terrain_splatmap_3.dds")
            };
