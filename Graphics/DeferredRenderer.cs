...
namespace Freefall.Graphics
{
    public class DeferredRenderer : RenderPipeline
    {
        ...
        {
            Albedo = new RenderTexture2D(Engine.Device, width, height, Format.R8G8B8A8_UNorm);
            ...
            LightBuffer = new RenderTexture2D(Engine.Device, width, height, Format.R8G8B8A8_UNorm);
